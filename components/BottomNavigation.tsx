...
const BottomNavigation = ({activePage}: NavigationProps) => {
  ...
  return (
    <div className="bg-bg flex px-1 pb-2 items-center justify-evenly fixed left-0 min-w-100 max-w-full lgm:min-w-[360px] w-full md:w-auto md:min-w-[520px] bottom-0 text-xs" style={{ boxShadow: "rgb(17, 24, 39) 0px -15px 15px"}}>
      <div className={`flex flex-col px-5 py-2 rounded-full items-center ${activePage == 'category' ? 'bg-blue-950' : ''} w-[100px]`} onClick={() => router.push('/category')}>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
        <p className="mt-1">Category</p>
      </div>
      <div className={`flex flex-col px-5 py-2 rounded-full items-center ${activePage == 'home' ? 'bg-blue-950' : ''} w-[100px]`} onClick={() => router.push('/home')}>
      ...
      <div className={`flex flex-col px-5 py-2 rounded-full items-center ${activePage == 'profile' ? 'bg-blue-950' : ''} w-[100px]`} onClick={() => router.push('/profile')}>
