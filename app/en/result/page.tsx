	...
	return (
		<div className="px-5 pt-[4rem] pb-20 flex flex-col items-center w-full gap-6">
			<div className="max-w-[480px] max-h-[320px] mobile-width">
				<AdBanner slot_id="div-gpt-ad-123456789-en8" size={[[300, 250]]} id="/23302694015/QD8" />
			</div>
			...
			<div className="flex justify-evenly mt-20 gap-2 w-100">
			...
			<div className="mt-2 cursor-pointer">
				<button className=" flex gap-2 rounded-full px-7 py-2 border-2 border-[#1a2f77]" onClick={doubleCoin}>
					Double Your winnings<img src="/coin.svg" alt="coin" />
				</button>
			</div>
			...
			<div className="flex flex-col justify-between h-[90px]"><button className="rounded-full px-7 py-2" style={{ background: "rgb(26, 47, 119)" }} onClick={()=>router.push('/en/home')}>Home</button></div>
		</div>
	);
}
